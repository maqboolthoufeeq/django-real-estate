...
class Property(TimeStampedUUIDModel):
    ...
    postal_code = models.CharField(
        verbose_name=_("Postal Code"), max_length=100, default="0000"
    )
    street_address = models.CharField(
        verbose_name=_("Street Address"), max_length=200, default="Please Update Street"
    )
    ...
    price = models.DecimalField(
        verbose_name=_("Property Price"), max_digits=10, decimal_places=2, default=0.0
    )
    ...
    plot_area = models.DecimalField(
        verbose_name=_("Plot Area in Sqr.Meters"),
        max_digits=10,
        decimal_places=2,
        default=0.0,
    )
