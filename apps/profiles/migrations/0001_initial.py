# Generated by Django 3.2.7 on 2022-08-15 11:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(default='+393333333333', max_length=30, region=None, verbose_name='Phone Number')),
                ...
                ('country', django_countries.fields.CountryField(blank=True, default='IN', max_length=2, null=True, verbose_name='Country')),
                ('city', models.CharField(blank=True, default='Mumbai', max_length=180, null=True, verbose_name='City')),
