...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(
        verbose_name=_("Phone Number"), max_length=30, default="+393333333333"
    )
    about_me = models.TextField(
        verbose_name=_("About Me"), default="Say something about yourself"
    )
    license = models.CharField(
        verbose_name=_("Real Estate License"), max_length=50, blank=True, null=True
    )
    ...
    country = CountryField(verbose_name="Country", default="IN", blank=True, null=True)
    city = models.CharField(
        verbose_name=_("City"), max_length=180, default="Mumbai", blank=True, null=True
    )
