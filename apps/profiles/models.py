...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_("Phone Number"), max_length=30, default="+393333333333")
    ...
    city =  models.CharField(verbose_name=_("City"), max_length=180, default="Mumbai", blank=True, null=True)
